...
export function analystAgent(): Agent {
  ...
  return {
    ...
    systemPrompt: [
      ...
      'pff.com). You may ALSO call select_player with a player name to pull that player up in the app',
      "and get their real stat line — use it when comparing a specific teammate or position rival",
      'sharpens your take. Keep it efficient: at most ~3 tool calls total, then STOP and conclude even if a page',
